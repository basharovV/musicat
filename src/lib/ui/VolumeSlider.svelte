<script lang="ts">
    ...
    $: {
        const thumbBg = btoa(`<svg width="20" height="20" fill="none" xmlns="http://www.w3.org/2000/svg">
            <g clip-path="url(#a)">
        ...
        document.documentElement.style.setProperty('--transport-volume-thumb-url', `url('data:image/svg+xml;base64,${thumbBg}')`);
    }
</script>
