...
const en = {
    ...
    library: {
        ...
        empty: {
            title: 'Click "Import library" or just drag + drop a folder here',
            subtitle: "You can always add more music later",
            import: "Import library +",
            formats: "Supports MP3, FLAC, OGG, AAC and WAV",
            addFoldersToWatch: "or add folders to watch",
            importing: "🥁Importing...",
        },
    ...
    updater: {
        ...
        upToDate: "Musicat is up to date.",
        ...
        titleInstalling: "Installing update…",
