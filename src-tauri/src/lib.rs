...
pub fn run() {
    ...
    let mut builder = tauri::Builder::default()
        ...
        .setup(|app| {
            ...
            // Note:
            // theme only supported on macOS 10.14+.
            // See https://docs.rs/tauri/2.0.0-beta.16/tauri/webview/struct.WebviewWindowBuilder.html#method.theme
            #[cfg(target_os = "macos")]
            {
                window_builder = window_builder
