...
use symphonia::core::audio::{AudioBufferRef, Layout, RawSampleBuffer, SampleBuffer, SignalSpec};
...
#[tauri::command]
pub fn get_devices(app_handle: tauri::AppHandle) -> Option<AudioDevices> {
    // Get default host.
    let host = cpal::default_host();
